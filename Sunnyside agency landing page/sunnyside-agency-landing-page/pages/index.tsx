		...
		<main className={styles.main}>
			...
			<section className={styles.sec_4}>
				...
				<div className={styles.testimonies}>
					{
						testimonies.map((tesimony, index) => <Testimony key={index} {...tesimony} />)
					}
				</div>
			</section>
