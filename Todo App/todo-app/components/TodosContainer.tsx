...
const TodosContainer: React.FC<Props> = ({ }) => {
    ...
    return (
        <div>
            <ul className='shadow-lightTheme-very-dark-grayish-blue/4 divide-y-[1px] divide-lightTheme-very-light-grayish-blue overflow-hidden rounded-md shadow-2xl dark:divide-darkTheme-very-dark-grayish-blue  dark:shadow-black'>
